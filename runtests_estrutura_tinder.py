...
'''
    ...
    a idéia é que temos o usuário de id 9 dizendo que tem interesse em conversar
    com o(a) usuário(a) de id 3.
    ...
    pessoas 1,2 e 5
    todo mundo gosta do 5
    5 gosta do 1 e do 2
    1 gosta do 2
    database['interesses'][5] = [1,2]
    database['interesses'][1] = [2,5]
    database['interesses'][2] = [5]
...
'''
    ...
    database['interesses'][3]=[9,4,2]
    database['interesses'][2]=[9,3]
    database['interesses'][4]=[2,9]
    database['interesses'][9]=[2,4]
...
'''
    ...
    aurelia = {'nome':'aurelia','id':90,'sexo':'mulher','buscando':['homem','mulher']}
    diana   = {'nome':'diana','id':91,'sexo':'mulher','buscando':['mulher']}
    funciona like do 9 pro 90 (ele busca mulheres, e 90 é mulher)
    funciona like do 9 pro 91 (ele busca mulheres, e 91 é mulher)
    nao funciona like do 91 pro 90 (ela busca mulheres, e 9 é homem)
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_p2_00_interesse_com_pessoas_validas(self):
        ...
        #crio a pessoa 9
        i.adiciona_pessoa({'nome':'Marcos','id':9})
        ...
        i.adiciona_pessoa({'nome':'Ana','id':3})
    ...
    def test_p4_01_match_compativel(self):
        i.reseta()
        maximus = {'nome':'Marcos','id':9,'sexo':'homem','buscando':['mulher']}
        ...
        #crio aurelia
        aurelia = {'nome':'Ana','id':3,'sexo':'mulher','buscando':['mulher',"homem"]}
